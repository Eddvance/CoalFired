...
import io.coalfired.model.ProductOffering;
...
public interface ProductOfferingApi {
    ...
    @Operation(summary = "List or find ProductOffering objects", description = "This operation list or find ProductOffering entities", tags={ "productOffering" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Success", content = @Content(mediaType = "application/json;charset&#x3D;utf-8", array = @ArraySchema(schema = @Schema(implementation = ProductOffering.class)))),
    ...
    ResponseEntity<List<ProductOffering>> listProductOffering(@Parameter(in = ParameterIn.QUERY, description = "Comma-separated properties to be provided in response" ,schema=@Schema()) @Valid @RequestParam(value = "fields", required = false) String fields
...
, @Parameter(in = ParameterIn.QUERY, description = "Requested number of resources to be provided in response" ,schema=@Schema()) @Valid @RequestParam(value = "limit", required = false) Integer limit
    ...
    @Operation(summary = "Retrieves a ProductOffering by ID", description = "This operation retrieves a ProductOffering entity. Attribute selection is enabled for all first level attributes.", tags={ "productOffering" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Success", content = @Content(mediaType = "application/json;charset&#x3D;utf-8", schema = @Schema(implementation = ProductOffering.class))),
    ...
    @RequestMapping(value = "/productOffering/{id}",
        produces = { "application/json;charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<ProductOffering> retrieveProductOffering(@Parameter(in = ParameterIn.PATH, description = "Identifier of the ProductOffering", required=true, schema=@Schema()) @PathVariable("id") String id
