...
public interface ProductOfferingPriceApi {
    ...
    @Operation(summary = "List or find ProductOfferingPrice objects", description = "This operation list or find ProductOfferingPrice entities", tags={ "productOfferingPrice" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Success", content = @Content(mediaType = "application/json;charset&#x3D;utf-8", array = @ArraySchema(schema = @Schema(implementation = ProductOfferingPrice.class)))),
    ...
    ResponseEntity<List<ProductOfferingPrice>> listProductOfferingPrice(@Parameter(in = ParameterIn.QUERY, description = "Comma-separated properties to be provided in response" ,schema=@Schema()) @Valid @RequestParam(value = "fields", required = false) String fields
...
, @Parameter(in = ParameterIn.QUERY, description = "Requested number of resources to be provided in response" ,schema=@Schema()) @Valid @RequestParam(value = "limit", required = false) Integer limit
    ...
    @Operation(summary = "Retrieves a ProductOfferingPrice by ID", description = "This operation retrieves a ProductOfferingPrice entity. Attribute selection is enabled for all first level attributes.", tags={ "productOfferingPrice" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Success", content = @Content(mediaType = "application/json;charset&#x3D;utf-8", schema = @Schema(implementation = ProductOfferingPrice.class))),
    ...
    @RequestMapping(value = "/productOfferingPrice/{id}",
        produces = { "application/json;charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<ProductOfferingPrice> retrieveProductOfferingPrice(@Parameter(in = ParameterIn.PATH, description = "Identifier of the ProductOfferingPrice", required=true, schema=@Schema()) @PathVariable("id") String id
