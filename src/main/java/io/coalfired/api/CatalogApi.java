...
public interface CatalogApi {
    ...
    ResponseEntity<List<Catalog>> listCatalog(@Parameter(in = ParameterIn.QUERY, description = "Comma-separated properties to be provided in response" ,schema=@Schema()) @Valid @RequestParam(value = "fields", required = false) String fields
...
, @Parameter(in = ParameterIn.QUERY, description = "Requested number of resources to be provided in response" ,schema=@Schema()) @Valid @RequestParam(value = "limit", required = false) Integer limit
    ...
    @RequestMapping(value = "/catalog/{id}",
        produces = { "application/json;charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<Catalog> retrieveCatalog(@Parameter(in = ParameterIn.PATH, description = "Identifier of the Catalog", required=true, schema=@Schema()) @PathVariable("id") String id
